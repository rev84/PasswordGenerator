...
var CLIPBOARD, defGenerate, initialize, mt_rand, shuffle;
...
defGenerate = function() {
  return $('#generate').on('click', function() {
    ...
    $('#passwords').prepend($('<div>').append($('<span>').addClass('password').html(password).attr('data-clipboard-text', password).on('click', function() {
